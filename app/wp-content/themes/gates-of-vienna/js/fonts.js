/*
 ...
 MyFonts Webfont Build ID 2788016, 2014-04-03T12:22:46-0400
 ...
 Webfont: Perpetua Std Italic by Monotype 
 URL: http://www.myfonts.com/fonts/mti/perpetua/std-italic/

 Webfont: Perpetua Std Roman by Monotype 
 URL: http://www.myfonts.com/fonts/mti/perpetua/std-roman/


 License: http://www.myfonts.com/viewlicense?type=web&buildid=2788016
 ...
 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2a8ab0";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=1;
...
for(var fonts=[{fontFamily:"PerpetuaMTStd-Italic",url:wfpath+"2A8AB0_0"+suffix+"_0."+webfontType},{fontFamily:"PerpetuaMTStd",url:wfpath+"2A8AB0_1"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+";");fonts[i].fontWeight&&(css+="font-weight: "+fonts[i].fontWeight+
